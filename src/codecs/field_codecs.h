...
// todo: use same dfp lib
// now macos version uses separate dfp library
...
#else
extern "C" double dfp_toDouble(int64_t value);
extern "C" int64_t dfp_fromDouble(double value);
#endif
